...
\end{equation}
Friend-or-foe Q-learning has the same convergence property as Nash Q-learning\footnote{\textit{Spolier}: Balacing Q-learning is a \correctquote{soft} version of friend-or-foe Q-learning}, while having a unique solution unlike Nash equilibrium solution.